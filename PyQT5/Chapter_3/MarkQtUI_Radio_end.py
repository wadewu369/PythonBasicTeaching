...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.selectRadionButton = QtWidgets.QPushButton(self.verticalLayoutWidget)
        self.selectRadionButton.setObjectName("selectRadionButton")
        self.verticalLayout_2.addWidget(self.selectRadionButton)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.selectRadionButton.setText(_translate("MainWindow", "你最後選擇的飲料是？"))
